...
publication_reference <- "HC 40223"
...
witnesses_present <- 
  paste("Sir Kevin Tebbit KCB CMG, Permanent Under-Secretary of State", 
        "Sir Peter Spencer KCB, Chief of Defence Procurement",
        "Lieutenant General Rob Fulton, Deputy Chief of the Defence Staff for Equipment Capability, Ministry of Defence", 
        "Mr Mike Turner CBE, Chief Executive, BAE Systems plc",
        sep = "; ")

publication_title <- "Oral evidence Taken before the Committee of Public Accounts"
publication_date <- "Monday 23 February 2004"
...
src <- pages %>%
  purrr::map(function(p){
    ...
    url <- "https://publications.parliament.uk/pa/cm200304/cmselect/cmpubacc/383/40223{p}.htm"
...
# Save -----
pac_200304_hc40223 <- list(meta = meta, transcript = text)
save(object = pac_200304_hc40223 , file = "data/pac_200304_hc40223.rda")
