...
publication_reference <- "HC 10115"

inquiry_link <- "https://publications.parliament.uk/pa/cm200102/cmselect/cmpubacc/368/36802.htm"
publication_link <- "https://publications.parliament.uk/pa/cm200001/cmselect/cmpubacc/136/1011501.htm"

members_present <- 
  paste("Mr David Davis, in the Chair",
        "Mr Simon Burns",	"Mr David Rendel",
        "Mr Alan Campbell",	"Mr Gerry Steinberg",
...
publication_date <- "MONDAY 15 JANUARY 20010"
...
src <- purrr::map(pages, function(p){
  ...
  url <- stringr::str_glue("https://publications.parliament.uk/pa/cm200001/cmselect/cmpubacc/136/10115{p}.htm")  
...
# Save ----
pac_200102_hc10115 <- list(meta = meta, transcript = text)
save(object = pac_200102_hc10115 , file = "data/pac_200102_hc10115.rda")
